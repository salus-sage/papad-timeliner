...
{% block rootBody %}
  <div class="fesk-layout">
      ...
      {% block docsHeader %}
        <div class="fesk-header">
          <h3 class="fesk-header__logo">
            {% block title %}
              <a href="/">{{ props.page.title or title | safe }}</a>
            {% endblock %}
          </h3>
          {% if pkg.repository %}
    ...
    {% endblock %}
    {% block footer %}
      <footer class="fesk-footer">
        {% block footerLogo %}
          <a class="fesk-footer__logo" href="https://digirati.com/" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 121 39">
              <g fill="none" fill-rule="evenodd">
                ...
                <path fill="#000" d="M99.374 22.23l-11.12-11.11L99.374 0l11.12 11.12-11.12 11.11zm-9-11.12l9 9 9-9-9-9-9 9z"/>
                <path fill="#000" d="M109.074 22.23l-11.11-11.11L109.084 0l11.12 11.12-11.13 11.11zm-9-11.12l9 9 9-9-9-9-9 9z"/>
              </g>
            </svg>
