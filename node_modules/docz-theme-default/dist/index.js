...
const ButtonSwap = (_a) => {
    var { as: Button$1 = Button, onClick, swap, children } = _a, props = tslib_1.__rest(_a, ["as", "onClick", "swap", "children"]);
    ...
    return (React.createElement(Button$1, Object.assign({ onClick: handleClick }, props), on ? swap : children));
};
...
const ClipboardAction = (_a) => {
    var { content } = _a, props = tslib_1.__rest(_a, ["content"]);
    return (React.createElement(ActionButton, Object.assign({}, props, { title: "Copy to clipboard", onClick: () => copy(content), swap: React.createElement(Check, { width: 17 }) }),
        React.createElement(Clipboard$1, { width: 15 })));
};
...
const ResizeBar = ({ onChangeSize }) => (React.createElement(Wrapper, null,
    React.createElement(Buttons, null,
        React.createElement(ActionButton, { onClick: () => onChangeSize('360px', '640px'), title: "Smartphone" },
            React.createElement(Smartphone, { width: 20 })),
        React.createElement(ActionButton, { onClick: () => onChangeSize('768px', '1024px'), title: "Tablet" },
            React.createElement(Tablet, { width: 20 })),
        React.createElement(ActionButton, { onClick: () => onChangeSize('1366px', '1024px'), title: "Monitor" },
...
const Editor = (_a) => {
    ...
    return (React.createElement(Wrapper$1, { className: className },
        React.createElement(CodeMirror, Object.assign({}, editorProps(config))),
        React.createElement(Actions$1, null, actions || React.createElement(ClipboardAction, { content: code }))));
};
Editor.defaultProps = {
    mode: 'js',
    readOnly: true,
...
const Playground = ({ position, code: initialCode, codesandbox, className, style, scope, wrapper: CustomWrapper = React.Fragment, }) => {
    ...
    return (React.createElement(reactLive.LiveProvider, { code: code, scope: scope, transformCode: transformCode },
        React.createElement(Overlay, { full: fullscreen },
            ...
            React.createElement(Resizable, Object.assign({}, resizableProps),
                React.createElement(Wrapper$2, { full: fullscreen },
...
const H2 = (_a) => {
    ...
    const { linkComponent: Link } = docz.useConfig();
    if (!Link)
        return null;
    return (React.createElement(Heading, Object.assign({}, props),
        React.createElement(Link, { "aria-hidden": true, to: `${pathname}#${props.id}` },
            React.createElement(Icon, { className: "heading--Icon", height: 20 })),
        children));
};
...
`;
const Link = (_a) => {
    var { href } = _a, props = tslib_1.__rest(_a, ["href"]);
    const { separator, linkComponent: Link } = docz.useConfig();
    const docs = docz.useDocs();
    const toCheck = React.useMemo(() => [
        location.pathname
            .split(separator)
            .slice(0, -1)
            .join(separator)
    ...
    return isInternal ? (React.createElement(LinkStyled, Object.assign({ as: Link }, props, { to: nHref }))) : (React.createElement(LinkStyled, Object.assign({}, props, { href: nHref })));
};
...
const Svg = styled__default.svg `
  ...
  right: 0;
`;
const GithubLink = ({ repository }) => (React.createElement(Link$1, { href: repository, target: "_blank", "aria-label": "View source on Github" },
    React.createElement(Svg, { width: "80", height: "80", viewBox: "0 0 250 250", "aria-hidden": "true" },
        ...
        React.createElement("path", { className: "octo-arm", fill: "currentColor", d: "M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6 C119.2,72.0 123.4,76.3 123.4,76.3 C127.3,80.9 125.5,87.3 125.5,87.3 C122.9,97.6 130.6,101.9 134.4,103.2" }),
        React.createElement("path", { className: "octo-body", fill: "currentColor", d: "M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2 139.9,98.4 142.2,98.6 C133.8,88.0 127.5,74.4 143.8,58.0 C148.5,53.4 154.0,51.2 159.7,51.0 C160.3,49.4 163.2,43.6 171.4,40.1 C171.4,40.1 176.1,42.5 178.8,56.2 C183.1,58.6 187.2,61.8 190.9,65.4 C194.5,69.0 197.7,73.2 200.1,77.6 C213.8,80.2 216.3,84.9 216.3,84.9 C212.7,93.1 206.9,96.0 205.4,96.6 C205.1,102.4 203.0,107.8 198.3,112.5 C181.9,128.9 168.3,122.5 157.7,114.1 C157.9,116.9 156.7,120.9 152.7,124.9 L141.0,136.5 C139.8,137.7 141.6,141.9 141.8,141.8 Z" }))));
...
`;
const Logo = ({ showBg }) => {
    const { title, linkComponent: Link, themeConfig: { logo }, } = docz.useConfig();
    if (!Link)
        return null;
    return (React.createElement(Wrapper$4, { showBg: showBg },
        React.createElement(Link, { to: "/" }, logo ? (React.createElement(LogoImg, { src: logo.src, width: logo.width, alt: title })) : (React.createElement(LogoText, null, title)))));
};
...
const Input = styled__default.input `
  ...
  color: ${sidebarText};
`;
const Search = ({ onSearch }) => (React.createElement(Wrapper$5, null,
    React.createElement(Icon$1, null),
    React.createElement(Input, { type: "text", placeholder: "Search here...", onChange: (ev) => {
...
`;
const SmallLink = (_a) => {
    var { as: Component, slug, location } = _a, props = tslib_1.__rest(_a, ["as", "slug", "location"]);
    const [isActive, setActive] = React.useState(false);
    React.useEffect(() => {
        const currentHash = location.hash && location.hash.slice(1, Infinity);
        setActive(Boolean(slug === currentHash));
    }, [location]);
    return React.createElement(Link$2, Object.assign({ as: Component }, props, { className: isActive ? 'active' : '' }));
};
...
const MenuHeadings = ({ route, onClick }) => {
    ...
    return headings && headings.length > 0 ? (React.createElement(router.Location, null, ({ location }) => (React.createElement(Submenu, null, headings.map((heading) => (React.createElement(SmallLink, { as: Link, location: location, key: heading.slug, onClick: onClick, to: `${route}#${heading.slug}`, slug: heading.slug }, heading.value))))))) : null;
};
...
const MenuLink = React.forwardRef(({ item, children, onClick, onActiveChange }, ref) => {
    const { linkComponent } = docz.useConfig();
    ...
    return (React.createElement(Wrapper$6, { active: active },
        item.route ? (React.createElement(Link, Object.assign({}, linkProps, { to: item.route, innerRef: $el, activeClassName: "active", partiallyActive: true }))) : (React.createElement(LinkAnchor, Object.assign({}, linkProps, { ref: $el, href: item.href || '#', target: item.href ? '_blank' : '_self' }, !item.href && {
            onClick: (ev) => {
                ev.preventDefault();
                linkProps.onClick && linkProps.onClick(ev);
            },
        }))),
        active && item.route && React.createElement(MenuHeadings, { route: item.route })));
});
...
`;
const Hamburger = ({ opened, onClick }) => (React.createElement(ToggleButton, { opened: opened, onClick: onClick },
    React.createElement(Icon$3, { opened: opened },
        React.createElement(IconLine, { opened: opened }),
        React.createElement(IconLine, { opened: opened }),
        React.createElement(IconLine, { opened: opened }))));
...
const Empty = styled__default.div `
  ...
  color: ${sidebarText$2};
`;
const Footer = styled__default.div `
  padding: 10px 0;
  display: flex;
  align-items: center;
  justify-content: center;
...
const FooterLink = styled__default.a `
  ...
  margin-left: 5px;
`;
const FooterLogo = styled__default(Docz) `
  fill: ${sidebarText$2};
`;
...
const Sidebar = () => {
    ...
    const menus = docz.useMenus({ query });
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Wrapper$8, { opened: hidden },
            React.createElement(Content, null,
                React.createElement(Hamburger, { opened: !hidden, onClick: handleSidebarToggle }),
                React.createElement(Logo, { showBg: !hidden }),
                React.createElement(Search, { onSearch: setQuery }),
                menus && menus.length === 0 ? (React.createElement(Empty, null, "No documents found.")) : (React.createElement(Menus, null, menus &&
                    menus.map(menu => (React.createElement(Menu, { key: menu.id, item: menu, sidebarToggle: handleSidebarToggle, collapseAll: Boolean(query.length) }))))),
                React.createElement(Footer, null,
                    "Built with",
                    React.createElement(FooterLink, { href: "https://docz.site", target: "_blank" },
                        React.createElement(FooterLogo, { width: 40 }))))),
        React.createElement(ToggleBackground, { opened: hidden, onClick: handleSidebarToggle })));
};
...
const Subtitle = styled__default.p `
  ...
  font-size: 18px;
`;
const NotFound = () => (React.createElement(Main, null,
    React.createElement(Sidebar, null),
    React.createElement(Wrapper$9, null,
        React.createElement(Title, null, "Page Not Found"),
        React.createElement(Subtitle, null, "Check if you haven't changed the document route or deleted it!"))));
...
const Page = ({ children, doc: { link, fullpage, edit = true }, }) => {
    const { repository } = docz.useConfig();
    const content = (React.createElement(React.Fragment, null,
        link && edit && (React.createElement(EditPage, { href: link, target: "_blank" },
            React.createElement(EditIcon, { width: 14 }),
            " Edit page")),
        children));
    return (React.createElement(Main, null,
        repository && React.createElement(GithubLink, { repository: repository }),
        !fullpage && React.createElement(Sidebar, null),
...
const Title$1 = styled__default.div `
  display: flex;
  border-bottom: 1px solid ${__chunk_1.get('colors.sidebarBg')};
`;
const PropName = styled__default.span `
  background: ${__chunk_1.get('colors.sidebarBg')};
  color: ${__chunk_1.get('colors.primary')};
  padding: 5px 10px;
...
const Props = ({ props, getPropType, }) => {
    ...
    const Paragraph = React.useMemo(() => styled__default(components.P || 'p') `
      font-size: 16px;
      color: ${__chunk_1.get('colors.sidebarTex')};
    `, []);
    return (React.createElement(React.Fragment, null, entries.map(([key, prop]) => {
        if (!prop.type && !prop.flowType)
            return null;
        return (React.createElement(Wrapper$b, { key: key },
            React.createElement(Title$1, null,
                React.createElement(PropName, null, key),
                React.createElement(PropType, null, getPropType(prop)),
                prop.defaultValue && (React.createElement(PropDefaultValue, null, prop.defaultValue.value === "''" ? (React.createElement("em", null, "= [Empty String]")) : (React.createElement("em", null,
                    "= ",
                    prop.defaultValue.value.replace(/\'/g, '"'))))),
                prop.required && (React.createElement(PropRequired, null,
                    React.createElement("em", null, "required")))),
            prop.description && React.createElement(Paragraph, null, prop.description)));
    })));
};
...
`;
const Table = (props) => (React.createElement(Wrapper$c, null,
    React.createElement(TableStyled, Object.assign({}, props))));
...
const Theme = ({ children }) => (React.createElement(__chunk_1.ThemeProvider, null,
    React.createElement(Global, null),
    React.createElement(docz.ComponentsProvider, { components: components }, children)));
const enhance = docz.theme(config, (_a) => {
    var { mode, codemirrorTheme } = _a, config = tslib_1.__rest(_a, ["mode", "codemirrorTheme"]);
