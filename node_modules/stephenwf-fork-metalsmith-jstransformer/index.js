 ...
 */
function getTransformer(name, customTransformer) {
  if (name in transformers) {
    return transformers[name]
  }
  const transformer = customTransformer ? customTransformer(name) : toTransformer(name)
...
module.exports = function (opts) {
  ...
  const customTransformer = opts.engineOptions ? opts.engineOptions.customTransformer : null
  ...
  return function (files, metalsmith, done) {
    ...
    function compileLayout(layout, done) {
      ...
      transform = getTransformer(transform, customTransformer)
      if (transform) {
